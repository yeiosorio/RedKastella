...
(function ($) {
    ...
    var changeSkin = function () {
        ...
        var skin = $.cookie("skin"),
            ...
            file = $.cookie("skin_file");
    
        if (typeof skin != 'undefined') {

            
            asyncLoader([ baseUrl + 'css/theme/' + file + '.css' ], function () {
    ...
    $('[data-skin]').on('click', function () {
        ...
        $.cookie("skin_file", $(this).data('file'));
        ...
        $.ajax({
                url: baseUrl + 'UserPreferences/savePreference',
                type: 'post',
                data: { 
                    skin: $(this).data('skin'),
                    skin_file: $(this).data('file')
                },
    ...
    //     // Ajax to take the skin from user preferences
    //     $.ajax({
    //             url: baseUrl + 'UserPreferences/getUserPreferencesAjax',
    //             type: 'post',
    //             dataType:'json',
    //             success: function (data) {
    ...
    //                         $.cookie("skin", "default-nav-inverse");

    //                         $.cookie("skin_file", "skin-default-nav-inverse");
    ...
    //                     $.cookie("skin", data.skin);

    //                     $.cookie("skin_file", data.skin_file);
...
function initScripts() {
    var $scripts = [
        baseUrl + "js/theme/vendor/maps/google/jquery-ui-map/ui/jquery.ui.map.js",
        baseUrl + "js/theme/vendor/maps/google/jquery-ui-map/ui/jquery.ui.map.extensions.js",
        baseUrl + "js/theme/vendor/maps/google/jquery-ui-map/ui/jquery.ui.map.services.js",
        baseUrl + "js/theme/vendor/maps/google/jquery-ui-map/ui/jquery.ui.map.microdata.js",
        baseUrl + "js/theme/vendor/maps/google/jquery-ui-map/ui/jquery.ui.map.microformat.js",
        baseUrl + "js/theme/vendor/maps/google/jquery-ui-map/ui/jquery.ui.map.overlays.js",
        baseUrl + "js/theme/vendor/maps/google/jquery-ui-map/ui/jquery.ui.map.rdfa.js",
        baseUrl + "js/theme/vendor/maps/google/jquery-ui-map/addons/infobox_packed.js",
        baseUrl + "js/theme/vendor/maps/google/jquery-ui-map/addons/markerclusterer.min.js"
    ];
