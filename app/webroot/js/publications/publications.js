...
$(document).on('click','.copyLinkShare', function(){
  ...
  var url = 'redkastella.com/Publications/allPublications/'+id;
                            ...
                            "<div class='timeline-block'>"+
                              "<div class='panel panel-default'>"+
                                    ...
                                    newContent += "<div class='panel-body' >"+
                                      "<p><a href='"+baseUrl+"publications/allPublications/"+post.Post.id+"' style='text-decoration: underline;'> <b class='h4 margin-none'>"+post.Post.title+"</b></a><br/>"; 



                                      var hasYoutubeLink =  getFirstYoutubeLinkInText(post.Post.content);


                                      console.log("link de youtube");

                                      console.log(hasYoutubeLink);
                                      ...
                                      newContent += postContent(post.Post);
                                    ...
                                    // <!-- Fin Contenido -->
                                        ...
                                        // Fin sección número de comentarios y Me gusta
                                            ...
                                            newContent += "<li class='comment-form'>"+
                                                ...
                                                newContent += "<button type='button' style='float: left; margin-top: 5px; display:none;' "+
                                                  
                                                  "class='btn btn-primary copyLinkShare-"+post.Post.id+"' "+
                                                  
                                                  "data-post='"+JSON.stringify(post.Post)+"'"+

                                                  "data-toggle='tooltip' "+
                                                  "title='Haciendo Click aqui podras compartir esta novedad en cualquiera de tus red sociales' "+
                                                  "data-clipboard-text='http://redkastella.com/publications/allPublications/"+post.Post.id+"' "+
                                              ...
                                              "<button type='button' style='float: right; margin-top: 5px;' data-id='"+post.Post.id+"' "+
                                                ...
                                                " </button>";
                                                 ...
                                                 // boton comentar
                                                newContent += "<button type='submit' class='btn btn-primary comment-post' style='float: left; margin-top: 5px; margin-left: 50px;' title='Comentar'><i class='fa fa-comments'></i> </button>"+   
                            ...
                            "<div class='timeline-block'>"+
                              "<div class='panel panel-default'>"+
                                    ...
                                    newContent += "<div class='panel-body' >"+
                                      ...
                                      newContent += urlify(post.Post.content); 
