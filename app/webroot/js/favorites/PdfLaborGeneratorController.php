...
/**
    ...
    */
    ...
    public function printConceptoMedico($userId = "",$medical_id = null, $imprimir = true, $initialsUser = null, $identification = null, $datos, $info, $firm, $firmPatient)
    {

        var_dump( $firmPatient);  
        ...
        $html.='
            ...
            <table style="padding: 2px; width:95%">
                <tr style="font-size: 65%">
                    ...
                    <td style="width: 50%; height: 60px; text-align: justify; ">
                        <br><img src="'.$firmPatient.'" style="width:100px !important; height:60px !important;" >
                        <br>
    ...
    /**
    * Obtiene la url de la firma a partir de el id del appointment
    */
    public function getSignatureByAppointment($appointmentId){
        
        $firmas = $this->ResourceManager->getResources($appointmentId, 'studies_consents', 'consent_signature');
        $ultimaFirma = "";
        if( !empty( $firmas ) ){
            $ultimaFirma = $firmas[ count( $firmas ) -1 ]->url;
        }
    ...
    */
    public function printHistoriaClinica($userId = "",$medical_id = null, $imprimir = true, $initialsUser = null, $identification = null){
        ...
        $firmPatient = $this->getSignatureByAppointment($id_appointment);
    ...
    //    consultarHistoriaClinicaPruebas 
       ...
       //  $tipoHistoria = $datos['type_attention'];
        ...
        switch( $tipoHistoria )
        {
            ...
            //     // Clinimetrías
            //     $climinetria = '';
            $this->printConceptoMedico($userId, $medical_id, $imprimir, $initialsUser, $identification, $datos, $info, $firm, $firmPatient);
