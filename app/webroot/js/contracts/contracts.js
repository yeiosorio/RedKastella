...
$('#publicationsForm').submit( function(e) {
     ...
     */
    $.ajax({
          url: baseUrl+ 'Contracts/addPublication/',
          type: 'POST',
          dataType: 'json',
...
function getPublications(){
    ...
    $.ajax({
        ...
        dataType: "json",
        url: baseUrl+"Contracts/getContracts",
        success: function(response) {
...
function getPostById(data){
    ...
    return $.ajax({
            ...
            data: data, 
            dataType: "json",
            url: baseUrl+"Contracts/getPostById"
        });
...
$(document).on('submit','.publicationEditForm', function(e) {
     ...
     */
    $.ajax({
          url: baseUrl+ 'Contracts/editPost/',
          type: 'POST',
          dataType: 'json',
          data: formData,
          success: function(response){
...
function getEditForm(post){
  ...
  var form = "<form method='post' class='publicationEditForm'>"+
                            ...
                            //link del secop
                            "<input name='secoplink' value='"+post.SecopLink[0].link+"' type='url' placeholder='Ingrese el link que corresponde al contrato en SECOP' class='form-control' style='background-color:white;' maxlength='1000' required/>"+
                            
                            //identificador del link del secop
                            "<input type='hidden' value='"+post.SecopLink[0].id+"' name='secoplinkid' />"+   
...
function deletePost(){
      ...
      $.ajax({
        ...
        dataType: "json",
        url: baseUrl+"Contracts/deletePost",
        success: function(response) {
            /**
    ...
    var newContent =    "<div class='col-xs-12 col-md-12 col-lg-12 item' >"+
                            "<div class='timeline-block'>"+
                              "<div class='panel panel-default'>"+
                                    ...
                                    $.each(post.SecopLink,function(){

                                        newContent += "<b>Visitar Link </b><a href ='"+this.link+"' target='_blank'>aqu&iacute;</a><br/>";
                                        ...
                                        // Fin sección número de comentarios y Me gusta
                                            ...
                                            newContent += "<li class='comment-form'>"+
                                                ...
                                                "<span class='input-group-btn'>"+
                                                  "<div class='post-user-picture' style='float:left;background-image:url("+post.User.profilePic+")'></div>"+   
                                                    "</span>"+
