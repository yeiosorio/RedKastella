...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        previous: $('<a style="margin-left:-15%;margin-top:3%;">' + options.labelPrevious + '</a>').attr("href", "#").addClass("btn btn-default fa fa-reply"),
        next: $('<a style="margin-left:50%;margin-top:3%;">' + options.labelNext + '</a>').attr("href", "#").addClass("btn btn-default fa fa-share")
    };
