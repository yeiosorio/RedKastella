 ...
 */
	Configure:: write('Security.salt', 'MYhG93b0qyHlLWds2gu3VoUbWwvniR2G0Fga9mi');
	
	// Configure:: write('Security.salt', '$2a$10$1z8IBoPXQ/vK1Bo/qwiIku');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure:: write('Security.cipherSeed', '71159309657198942496749683645');
...
setlocale(LC_TIME, 'es_ES.utf8','es_ES','esp_ESP');
