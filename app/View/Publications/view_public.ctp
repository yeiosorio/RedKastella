        ...
        <div class="container-fluid "> <!--container-fluid-->
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-8 col-md-offset-2 text-center">
              <h4>
                Encuentra oportunidades de negocio y con&eacute;ctate con entidades, proveedores y contratistas. Comparte tus historias y promueve el desarrollo econ&oacute;mico.
              </h4>
            ...
            <div class="col-md-10 col-md-offset-1 text-center">
               ...
               <button class="btn btn-primary do-publication">
            ...
            <div class="col-md-10 col-md-offset-1 text-center">
              <a href="http://redkastella.com/landing/index.php/register/" class="btn btn-primary">
                <i class="fa fa-user-plus" aria-hidden="true"></i>
                  Registrarme
              </a>

              <a href="http://redkastella.com/landing" class="btn btn-primary">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content modal-margin-top">
      ...
      <div class="modal-header modal-pub-header">
        ...
        <a href="<?php echo $fullBaseUrl.'users/profile/'.$adminUser['username']; ?>">
      ...
      <div class="modal-body">
          ...
          <?php
                 ...
                 */
               echo $this->element('publications/addModalPublicationPublic');
