    ...
    <div class="navbar navbar-main navbar-primary navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="" style="border-right-color: #242424 !important; ">
            <!-- <img class="img-logo-left-menu" src="<?php // echo $baseUrl; ?>img/left-side-logo.jpeg" />  -->
 
            <img class="img-logo-left-menu" src="<?php echo $baseUrl; ?>img/Kastella200px.png" /> 
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <form class="navbar-form navbar-left login-form">
            <div class="form-group">
              ...
              <label>Usuario:</label>
              <input type="text" name="data[User][username]" class="form-control white-inputs username-input" placeholder="Nombre de Usuario">
          
              <label>Contraseña:</label>
              <input type="password" name="data[User][password]" class="form-control white-inputs" placeholder="Contraseña"> 
          
            </div>
            <button type="submit" class="btn btn-default btn-login-home">Iniciar Sesión</button>
          </form>
...
<!-- 
 ...
 -->
           ...
           <!--      <li>
                  ...
                  <a href="http://redkastella.com/index.php/register/" target="_blank">Registro</a>
