...
<!-- Categorias de tipos de contrato -->	
	<div class="col-md-5">
		<label>Categorias:</label>
			<select id="prefContractsCategory" class="form-control" size="10"></select>
	</div>
	...
	<div class="col-md-5">
		<label>Selección:</label>
			<select  class="form-control selected-categories" size="10"></select>
	</div>
	<!-- Fin categorias de tipos de contrato -->
...
<!-- Rango de valores -->
	<div class="col-md-12 valuesContainer">
...
<!-- bloque nuevo de separación de la acción de guardar -->
<div class="row">
<br/>
	<div class="col-md-4">
		<button type="button" id="savePreferences" class="btn btn-primary">
			<i class="btn-save-gls fa fa-floppy-o"></i>&nbsp;Guardar
		</button>
	</div>
</div>
<!-- Fin bloque Guardar -->
