                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" enctype="multipart/form-data" id="publicationsForm">
                            ...
                            <!-- Link del secop -->
                            <input name="secoplink" type="url" placeholder="Ingrese el link que corresponde al contrato en SECOP" class="form-control" style="background-color:white;" maxlength="1000" required/>
