                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" enctype="multipart/form-data" id="publicationsForm">
                            ...
                            <!-- Contenido -->
                            <textarea name="content" placeholder="Ingrese su texto..." rows="5" class="form-control content-publication" style="background-color:white;" maxlength="1000" required></textarea>
                            ...
                            <!-- Sección de botones -->
                            <div class="panel-body buttons-spacing-vertical text-center">
