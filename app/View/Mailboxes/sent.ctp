                ...
                <div class="row">
                    <ol class="breadcrumb" style="margin-bottom: -14px;">
                        <li><a href="#" onclick="history.back()">Volver</a></li>
                            <li class="active">Mensajería | Correo enviado</li>
                    </ol>
                    <div class="panel-body buttons-spacing-vertical">
                        <p style="padding-left: 26%">
        <nav>
            <ul class="pagination">
                <li><?php echo $this->Html->link(__('Correo Recibido'), array('action' => 'index')); ?></li>
            ...
            <div id="mis_correos">
                <table class="table table-striped">
                    ...
                    ?>
                        <td><?php echo h($mailbox['Mailbox']['username']); ?>&nbsp;</td>
                        ...
                        <td class="actions">
                            ...
                            <?php echo $this->Html->link(__('Responder'), array('action' => 'reply', $mailbox['Mailbox']['username'], $mailbox['Mailbox']['description'], $mailbox['CategoryMail']['id']), array('class' => 'btn btn-sm btn-default')); ?>
                            <?php //echo $this->Form->postLink(__('Borrar'), array('action' => 'delete', $mailbox['Mailbox']['id']), array('class' => 'btn btn-sm btn-default'), __('¿Está seguro que desea eliminar el correo # %s?', $mailbox['Mailbox']['id'])); ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    </tbody>
