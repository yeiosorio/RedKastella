       ...
       <div class="panel panel-default" style="border-radius:6px">
			...
			<?php echo $this->Form->create('Mailbox', array('role' => 'form')); ?>
				...
				<?php
					...
					echo $this->Form->input('username', array('class' => 'form-control', 'label' => '', 'value' => $goto));
					echo $this->Form->input('state', array('class' => 'form-control', 'type' => 'hidden', 'value' => 'unread'));
					echo $this->Form->input('description', array('class' => 'form-control', 'label' => '', 'value' => 'RE: '.$desc, 'maxlength' => '100'));
					echo $this->Form->input('category_mail_id', array('class' => 'form-control', 'label' => '',
                                                                      'options' => $subject, 'selected' => $category));
					echo "<br />";
