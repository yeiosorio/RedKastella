...
class PostPublic extends AppModel 
{
	var $name = 'PostPublic';
	...
	public function __construct($id = false, $table = null, $ds = null) {
		 ...
		 */
	    $this->virtualFields['ilike'] = $this->getIlike(421);
	...
	public function getIlike($userId){
		...
		return 'SELECT COUNT(likes.id) FROM likes WHERE likes.users_id = '.$userId.' AND likes.id in(SELECT post_likes.likes_id FROM post_likes WHERE post_likes.posts_id = PostPublic.id )';
	...
	public function getLikes(){
		...
		return 'SELECT COUNT(post_likes.id) as likes FROM post_likes where post_likes.posts_id = PostPublic.id';
	...
	public function newPost($title = null, $content = null, $privacyId = null, $userId = null, $postTypeName = null){
           ...
           if($this->save(Array(
           	...
           	return  $this->find('first',Array('conditions'=>array('PostPublic.users_id'=> $userId),'order' => array('PostPublic.id' => 'DESC')));
