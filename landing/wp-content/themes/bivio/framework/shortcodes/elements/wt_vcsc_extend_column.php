<?php
	if (function_exists('vc_add_param')) {
		...
		vc_add_param( "vc_column", array(
			'type'							=> 'dropdown',
			'heading'						=> __('Column Style','wt_vcsc'),
			'param_name'					=> 'style',
			'value'							=> array(
				__('None', 'wt_vcsc')  => '',
		...
		vc_add_param( "vc_column", array(
			...
			'description'           		=> __( 'Check this option to add a default shadow to this column.', 'wt_vcsc' ),
			'group' 						=> __( 'WT_VC Extensions', 'wt_vcsc')
		));
		vc_add_param("vc_column", array(
			'type' 							=> 'dropdown',
		...
		vc_add_param("vc_column", array(
			...
			'description'                   => __( 'Select background color for this column.', 'wt_vcsc' ),
			'group' 						=> __( 'WT_VC Extensions', 'wt_vcsc')
		));	
		vc_add_param("vc_column", array(
			'type' 							=> 'dropdown',
			...
			'admin_label' 					=> true,
			'description' 					=> __('Select background type for this column.', 'wt_vcsc'),
			'group' 						=> __( 'WT_VC Extensions', 'wt_vcsc'),
		));
		vc_add_param("vc_column", array(
			'type'							=> 'attach_image',
			...
			'value'							=> '',
			'description'					=> __( 'Select the background image for your column.', 'wt_vcsc' ),
			'dependency' 					=> array(
				'element' 	=> 'bg_type',
