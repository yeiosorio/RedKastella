(function($) {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		pp_settings = jQuery.extend({
			...
			other_markup: '<embed src="{path}" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="{width}" height="{height}" wmode="{wmode}" flashVars="{flashvars}"></embed>',iframe_markup:'<iframe src ="{path}" width="{width}" height="{height}" frameborder="no"></iframe>',	
		...
		*/
		...
		function _getFileType(itemSrc){
			...
			else if(itemSrc.match(/dailymotion\.com\/video/i)){return 'dailymotion';}
			else if(itemSrc.match(/metacafe\.com\/watch/i)){return 'metacafe';}
			else if(itemSrc.match(/cnn\.com\/video/i)){return 'cnn';}
			else if(itemSrc.match(/facebook\.com/i)){return 'facebook';}
